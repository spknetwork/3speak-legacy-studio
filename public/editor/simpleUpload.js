...
function simpleUpload(e, l, n) {
    var t = !1, a = null, o = 0, r = 0, i = [], s = [], p = "auto", u = null, f = null, d = "file", c = {}, m = {},
        h = function (e) {
        }, v = function (e) {
        }, y = function (e) {
        }, U = function (e) {
        ...
        }, k = [], E = [], S = {files: k}, z = 0, F = null, T = function (e, l) {
    ...
    function A(n) {
        if (1 == R(n)) {
            if (null != a) {
                if (null == a[n] || null == a[n]) return void W(n, {
                    name: "InternalError",
                ...
                if (window.FormData) {
                    ...
                    if (t.upload) {
                        ...
                        !function e(l, n, t) {
                            null != t && "" !== t || (t = null);
                            for (var a in n) void 0 === n[a] || null === n[a] ? l.append(null == t ? a + "" : t + "[" + a + "]", "") : "object" == typeof n[a] ? e(l, n[a], null == t ? a + "" : t + "[" + a + "]") : "boolean" == typeof n[a] ? l.append(null == t ? a + "" : t + "[" + a + "]", n[a] ? "true" : "false") : "number" == typeof n[a] ? l.append(null == t ? a + "" : t + "[" + a + "]", n[a] + "") : "string" == typeof n[a] && l.append(null == t ? a + "" : t + "[" + a + "]", n[a])
                        }(r, c), r.append(d, o);
                        var i = {
                            url: e, data: r, type: "post", cache: !1, xhrFields: m, beforeSend: function (e, l) {
                                N(n, e, l), E[n].xhr = e
                            }, xhr: function () {
            ...
            "object" == typeof l && null !== l ? function (l) {
                if (0 == l) {
                    var n = simpleUpload.queueIframe({
                        origin: function (e) {
                            ...
                            1 == R(l) && (E[l].iframe = null, simpleUpload.dequeueIframe(n), W(l, {
                                name: "RequestError",
                                message: e
                            }))
                        }
                    ...
                    var t = function e(l, n) {
                        null != n && "" !== n || (n = null);
                        var t = "";
                        for (var a in l) void 0 === l[a] || null === l[a] ? t += $("<div>").append($('<input type="hidden">').attr("name", null == n ? a + "" : n + "[" + a + "]").val("")).html() : "object" == typeof l[a] ? t += e(l[a], null == n ? a + "" : n + "[" + a + "]") : "boolean" == typeof l[a] ? t += $("<div>").append($('<input type="hidden">').attr("name", null == n ? a + "" : n + "[" + a + "]").val(l[a] ? "true" : "false")).html() : "number" == typeof l[a] ? t += $("<div>").append($('<input type="hidden">').attr("name", null == n ? a + "" : n + "[" + a + "]").val(l[a] + "")).html() : "string" == typeof l[a] && (t += $("<div>").append($('<input type="hidden">').attr("name", null == n ? a + "" : n + "[" + a + "]").val(l[a])).html());
                        return t
                    }(c);
                    F.attr("action", e + (-1 == e.lastIndexOf("?") ? "?" : "&") + "_iframeUpload=" + n + "&_=" + (new Date).getTime()).attr("target", "simpleUpload_iframe_" + n).prepend(t).submit()
                } else W(l, {name: "UnsupportedError", message: "Multiple file uploads not supported"})
    ...
    function O(e, l) {
        var n = "";
        if (0 == l) n = "init"; else if (1 == l) n = "uploading"; else if (2 == l) n = "success"; else if (3 == l) n = "error"; else {
            if (4 != l) return !1;
            n = "cancel"
        }
    ...
    !function () {
        if ("object" == typeof n && null !== n) {
            ...
            if ("number" == typeof n.limit && J(n.limit) && n.limit > 0 && (o = n.limit), "number" == typeof n.maxFileSize && J(n.maxFileSize) && n.maxFileSize > 0 && (r = n.maxFileSize), "object" == typeof n.allowedExts && null !== n.allowedExts) for (var e in n.allowedExts) i.push(n.allowedExts[e]);
            if ("object" == typeof n.allowedTypes && null !== n.allowedTypes) for (var e in n.allowedTypes) s.push(n.allowedTypes[e]);
            if ("string" == typeof n.expect && "" != n.expect) {
                var S = n.expect.toLowerCase(), T = ["auto", "json", "xml", "html", "script", "text"];
                for (var e in T) if (T[e] == S) {
                    p = S;
                    break
                }
            }
            if ("object" == typeof n.xhrFields && null !== n.xhrFields) for (var e in n.xhrFields) m[e] = n.xhrFields[e]
        }
        if ("object" == typeof l && null !== l && l instanceof jQuery) {
            if (!(l.length > 0)) return !1;
            l = l.get(0)
        }
        if (!t && window.File && window.FileReader && window.FileList && window.Blob && ("object" == typeof n && null !== n && "object" == typeof n.files && null !== n.files ? a = n.files : "object" == typeof l && null !== l && "object" == typeof l.files && null !== l.files && (a = l.files)), ("object" != typeof l || null === l) && null == a) return !1;
        ...
        if (null != a ? a.length > 0 && (M = a.length > 1 && window.FormData && $.ajaxSettings.xhr().upload ? o > 0 && a.length > o ? o : a.length : 1) : "" != l.value && (M = 1), M > 0) {
            ...
            for (var Q = 0; Q < M; Q++) !function (e) {
                E[e] = {state: 0, hashWorker: null, xhr: null, iframe: null}, k[e] = {
                    upload: {
                        index: e,
                        state: "init",
                        file: null != a ? a[e] : {name: l.value.split(/(\\|\/)/g).pop()},
                        cancel: function () {
                            if (0 == R(e)) O(e, 4); else {
                                if (1 != R(e)) return !1;
            ...
            if (!1 !== H) {
                var X = M;
                if ("number" == typeof H && J(H) && H >= 0 && H < M) for (var Y = X = H; Y < M; Y++) O(Y, 4);
                for (var G = [], K = 0; K < X; K++) !1 !== I(K, k[K].upload.file) && (G[G.length] = K);
                G.length > 0 ? (z = G.length, simpleUpload.queueUpload(G, function (e) {
                    !function (e) {
                        if (1 == R(e)) {
                            var n = null;
                            if (null != a) {
                                if (null == a[e] || null == a[e]) return void W(e, {
                                    name: "InternalError",
                                    message: "There was an error uploading the file"
                                });
                                n = a[e]
                            } else if ("" == l.value) return void W(e, {
                                name: "InternalError",
                                message: "There was an error uploading the file"
                            });
                            i.length > 0 && !function (e, n) {
                                if (null != n && null != n) {
                                    ...
                                    if (null != t && null != t && "" != t) {
                                        ...
                                        if ("" != a) {
                                            var o = !1;
                                            for (var r in e) if (e[r].toLowerCase() == a) {
                                                o = !0;
                                                break
                                            }
                                            return !!o
                                ...
                                if ("object" != typeof l || null === l) return !0;
                                var i = l.value;
                                if ("" != i) {
                            ...
                            }) : s.length > 0 && !function (e, l) {
                                if (null != l && null != l) {
                                    var n = l.type;
                                    if (null != n && null != n && "" != n) {
                                        n = n.toLowerCase();
                                        var t = !1;
                                        for (var a in e) if (e[a].toLowerCase() == n) {
                                            t = !0;
                                            break
                                        }
                                        return !!t
                                ...
                                if (null != l && null != l) {
                                    var n = l.size;
                                    if (null != n && null != n && "" != n && J(n)) return n <= e
                                }
                                return !0
                            }(r, n) ? W(e, {
                                name: "MaxFileSizeError",
                                message: "That file is too big"
                            }) : null != u && null != f ? function (e) {
                                if (null != a && null != a[e] && null != a[e] && window.Worker) {
                                    var l = a[e];
                                    if (null != l.size && null != l.size && "" != l.size && J(l.size) && (l.slice || l.webkitSlice || l.mozSlice)) try {
                                        ...
                                        return p.addEventListener("error", function (l) {
                                            ...
                                            file_size: l.size,
                                            start: 0
                                        }).end = n > l.size ? l.size : n, p.addEventListener("message", i, !1), (o = new FileReader).onload = s, l.slice ? r = l.slice(t.start, t.end) : l.webkitSlice ? r = l.webkitSlice(t.start, t.end) : l.mozSlice && (r = l.mozSlice(t.start, t.end)), o.readAsArrayBuffer(r), void (E[e].hashWorker = p)
                                    } catch (e) {
                                    }
                                }
                                A(e)
...
simpleUpload.maxUploads = 10, simpleUpload.activeUploads = 0, simpleUpload.uploads = [], simpleUpload.iframes = {}, simpleUpload.iframeCount = 0, simpleUpload.queueUpload = function (e, l) {
    ...
    for (var l = 0; 0 == l || l in simpleUpload.iframes;) l = Math.floor(999999999 * Math.random() + 1);
    ...
    if ("auto" == e) {
        if ("string" == typeof l && "" != l) {
            ...
            for (var r in o) if (o[r] == a) {
                t = a;
                break
            }
        }
    } else t = e;
    if ("auto" == t) return void 0 === n ? "" : "object" == typeof n ? n : String(n);
    if ("json" == t) {
